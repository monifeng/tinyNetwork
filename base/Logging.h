...
#define LOG_INFO if (tnet::Logger::logLevel() <= tnet::Logger::INFO) \
  tnet::Logger(__FILE__, __LINE__).stream()
#define LOG_WARN tnet::Logger(__FILE__, __LINE__, tnet::Logger::WARN).stream()
#define LOG_ERROR tnet::Logger(__FILE__, __LINE__, tnet::Logger::ERROR).stream()
#define LOG_FATAL tnet::Logger(__FILE__, __LINE__, tnet::Logger::FATAL).stream()
...
#define CHECK_NOTNULL(val) \
  ::tnet::CheckNotNull(__FILE__, __LINE__, "'" #val "' Must be non NULL", (val))
